...
<template>
  <main>
    ...
    <div class="list-container">
      ...
      <ul class="list-items">
        <li @dblclick="deleteItem(index)" @click="item.done = !item.done" :class="{'done':item.done}" v-for="(item, index) in list" class="list-item">{{item.title}}</li>
      </ul>
